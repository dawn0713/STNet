...
parser.add_argument('--dset_pretrain', type=str, default='traffic', help='dataset name')
...
print('args:', args)
args.save_pretrained_model = 'stnet_pretrained_cw'+str(args.context_points)+'_patch'+str(args.patch_len) + '_stride'+str(args.stride) + '_epochs-pretrain' + str(args.n_epochs_pretrain) + '_mask' + str(args.mask_ratio) + '_model' + str(args.pretrained_model_id)
args.save_path = 'saved_models/' + args.dset_pretrain + '/masked_stnet/' + args.model_type + '/'
