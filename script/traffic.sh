...
do
    python -u stnet_finetune.py \
      --is_linear_probe 0 \
      --is_finetune 1 \
      --dset_finetune 'traffic' \
      --target_points $pred_len \
      --batch_size 8 \
      --n_epochs_finetune 20 \
      --pretrained_model './saved_models/traffic/masked_stnet/based_model/stnet_pretrained_cw512_patch12_stride12_epochs-pretrain10_mask0.4_model1.pth' \
