...
parser.add_argument('--finetuned_model_id', type=int, default=96, help='id of the saved finetuned model')
parser.add_argument('--model_type', type=str, default='based_model', help='for multivariate model or univariate model')


args = parser.parse_args()
print('args:', args)
args.save_path = 'saved_models/' + args.dset_finetune + '/masked_stnet/' + args.model_type + '/'
...
if args.is_finetune: args.save_finetuned_model = args.dset_finetune+'_stnet_finetuned'+suffix_name
elif args.is_linear_probe: args.save_finetuned_model = args.dset_finetune+'_stnet_linear-probe'+suffix_name
else: args.save_finetuned_model = args.dset_finetune+'_stnet_finetuned'+suffix_name
...
if __name__ == '__main__':
    ...
    if args.is_finetune:
        ...
        args.dset = args.dset_finetune
        weight_path = args.save_path+args.dset_finetune+'_stnet_finetuned'+suffix_name
        # Test
